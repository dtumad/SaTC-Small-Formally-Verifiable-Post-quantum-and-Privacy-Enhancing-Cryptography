...
% Generally I think all of these things would be reasonable to try and do
% Is it worth mentioning QROM? "Our oracle based framework makes it natural/possible to view quantum computations as providing different kinds of oracles. We will extend with this and give proofs in both ROM and QROM"?
